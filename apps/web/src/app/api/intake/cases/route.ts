  ...
  try {
    ...
    await prisma.case.update({
      ...
      data: {
        ...
        // Store full structured analysis so the UI can render all fields
        aiExtractedEntities: {
          entities: classification.entities,
          keyFacts: summary.keyFacts,
          recommendedActions: summary.recommendedActions,
          caseReferences: summary.caseReferences ?? [],
          coreIssue: summary.coreIssue,
          desiredOutcome: summary.desiredOutcome,
          estimatedComplexity: summary.estimatedComplexity,
          urgencyReasoning: urgency.reasoning,
          riskFactors: urgency.riskFactors ?? [],
          timeConstraints: urgency.timeConstraints ?? [],
        } as never,
